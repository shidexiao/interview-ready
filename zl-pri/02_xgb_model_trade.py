...
input_variables = [x for x in input_variables if x not in ['credit_channel_cnt', 'credit_used_rat']]
...
shap_imp_1.head(10)
sel_cols = feature_importance['Feature'].tolist()[:50]

sel_cols = ['last60_due0_loanno_rat',
 'last30_due0_perdno_rat',
 'last120_advancerepayed2days_rat',
 'last120_advancerepayed_cnt',
 'last_30day_maxdueday',
 'future_60days_repaying_amt',
 'last30_advancerepayed2days_rat',
 'last120_advancerepayed5days_rat',
 'last_tx_datedif',
 'last120_advancerepayed5days_cnt',
 'last60_advancerepayed2days_rat',
 'max_last5mth_applyamt',
 'closeddistance_perd2_tx_maxdueday',
 'settled_amt',
 'avg_credit_lastmth5_use_rat',
 'max_credit_lastmth2_use_rat',
 'avg_credit_lastmth1_use_rat',
 'last_60day_maxdueday',
 'max_credit_lastmth5_use_rat',
 'last60_advancerepayed_cnt',
 'last120_advancerepayed5days_loanno_rat',
 'last30_advancerepayed_cnt',
 'min_credit_lastmth6_use_rat',
 'last60_advancerepayed5days_cnt',
 'avgcnt_last4mth_loanamt',
 'avg_credit_lastmth2_use_rat',
 'avg_last3mth_applyamt',
 'max_credit_lastmth4_use_rat',
 'refunding_days4_rat',
 'refunding_last180_days3_rat',
 'settled_cnt',
 'avg_last5mth_applyamt',
 'min_last1mth_applyamt',
 'closeddistance_perd3_tx_maxdueday',
 'avgcnt_future_60days_repaying_amt',
 'max_credit_lastmth6_use_rat',
 'future_180days_repaying_amt',
 'avgcnt_last3mth_loanamt',
 'maxrepayeddt_curday_dif',
 'max_last4mth_applyamt',
 'avgcnt_last1mth_applyamt',
 'min_credit_lastmth2_use_rat',
 'future_120days_repaying_amt',
 'avgcnt_future_120days_repaying_amt',
 'refunding_last180_days4_rat',
 'repaying_amt',
 'last60_due0_perdno_rat',
 'closeddistance_perd6_tx_maxdueday',
 'last_90day_maxdueday',
 ]
...
model_data_1['bcard_xgb_proba'] = gbm_model.predict(model_data_1[gbm_model.feature_name()])
model_data_1['bcard_score_v1_0'] = model_data_1['bcard_xgb_proba'].apply(score_card)
...
gbm_model.booster_.save_model(f'../model/bcard_lgbm_model_20241224.txt')
gbm_model = lgbm.Booster(model_file="../model/bcard_lgbm_model_20241224.txt")
shap_imp = calculate_importance(gbm_model, oot_sample, gbm_model.feature_name())

shap_imp.to_csv("../doc/feature_imp_20241226.csv", index=False)

model_data_1[['loan_no', 'bcard_xgb_proba', 'bcard_score_v1_0']].to_csv("../doc/model_score_20241226.csv", index=False)

shap_imp['Feature'].tolist()
