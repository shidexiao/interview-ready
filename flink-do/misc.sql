...
CREATE TABLE atreus_es.atreus_componentlog_202503 PARTITION OF atreus_es.atreus_componentlog_partd
FOR VALUES IN ('202503');
CREATE TABLE atreus_es.atreus_componentlog_202504 PARTITION OF atreus_es.atreus_componentlog_partd
FOR VALUES IN ('202504');
...
select * from mongo_ods.jinan

SELECT *, hg_binlog_event_type FROM zws_middleware.zl_drms_judgements where user_mobile_number='13240627111';
