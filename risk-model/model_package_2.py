...
class ModelPacker(object):
    ...
    def make_judgement(self, input_data_dict: Dict[str, Any], input_params: Dict[str, Any]) -> Tuple[Dict, Dict]:
        ...
        other_info = {'loan_apply_diff_days': diff_days, 'judge_status': judge_status}
...
# model_name = 'loan_rules_20230721_v1'
model_name = 'strategy_firstloan_rules_20240527_v2'

columns_it = ['user_success_credit_time', 'user_credit_amount_total', 'apply_principal', 'ZLC_credit_info', 'channel_code']
input_params = {'diff_days_limits': 30}
...
b = {'user_success_credit_time': '2024-05-13 13:41:00', 'user_credit_amount_total': 6000, 'apply_principal': 1000, 'ZLC_credit_info' : [{'creditAmt': 6000.0, 'usedAmt': 4000.0, 'channelCode': 'ICE_ZLSK_36', 'riskCode': 'FIN360'}, {'creditAmt': 8900.0, 'usedAmt': 0, 'channelCode': 'RS', 'riskCode': 'RS'}], 'channel_code': 'FIN360'}
b = {'user_success_credit_time': '2024-05-13 13:41:00', 'user_credit_amount_total': 6000, 'apply_principal': 1000, 'ZLC_credit_info' : [{'creditAmt': 6000.0, 'usedAmt': 4000.0, 'channelCode': 'ICE_ZLSK_36', 'riskCode': 'FIN360'}, {'creditAmt': 8900.0, 'usedAmt': 0, 'channelCode': 'RS', 'riskCode': 'RS'}], 'channel_code': 'RS'}
b = {'user_success_credit_time': '2024-05-13 13:41:00', 'user_credit_amount_total': 6000, 'apply_principal': 1000, 'ZLC_credit_info' : [], 'channel_code': 'RS'}
b = {'user_success_credit_time': '2024-05-13 13:41:00', 'user_credit_amount_total': 6000, 'apply_principal': 1000, 'ZLC_credit_info' : [{'creditAmt': 6000.0, 'channelCode': 'ICE_ZLSK_36', 'riskCode': 'FIN360'}, {'creditAmt': 8900.0, 'usedAmt': 0, 'channelCode': 'RS', 'riskCode': 'RS'}], 'channel_code': 'RS'}
